...
| 1.4 | Supabase (PostgreSQL) | DONE — ap-south-1, PG 17.6, schema applied, the 24 integration tests that existed at the time all passed against the transaction-mode pooler; the 17 added since (sweep, submit) are verified against local PG 17 only |
