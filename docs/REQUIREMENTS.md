...
| 6.7 | DECISIONS: judgement calls where the brief was vague | DONE — 31 entries |
...
| 6.12 | **Screen recording on a real device**, showing each feature | DONE — [v1.0.5 on a real phone](https://github.com/mj789-98/skill-trial-blitz/releases/download/v1.0.5/screen-recording-v1.0.5.mp4) against the live backend: a Blitz death paying $0.00, trains crossing the track, a run to 19 held to **Cash Out and paid $3.00 on a $1.00 entry**, and a Pop Shot round. The [v1.0.3 recording](https://github.com/mj789-98/skill-trial-blitz/releases/download/v1.0.3/screen-recording-v1.0.3.mp4) adds a break-even and more Pop Shot. Screenshots from the same phone cover the [insufficient-balance lobby](screenshots/insufficient-balance.png) the [server-unreachable screen](screenshots/cannot-reach-server.png), and a [request failing mid-session in airplane mode](screenshots/request-failed-offline.png). |
...
| 10% | Polish & completeness | strong — art pass done and verified on device; the screen recordings and screenshots (6.12) cover every feature, including a cash-out win; the APK is downloadable (6.13) |
