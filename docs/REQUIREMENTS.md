...
| 6.13 | Runnable build — an **APK** | DONE — [GitHub Release v1.0.1](https://github.com/mj789-98/skill-trial-blitz/releases/tag/v1.0.1). The APK talks to the deployed backend and is verified on a real phone with no cable and no emulators: signs in and loads the lobby from the live server in about three seconds |
